...
namespace SIStorage.Service.Exceptions;
...
public sealed class ServiceException : Exception
{
    ...
    /// Error code.
    /// </summary>
    public WellKnownSIStorageServiceErrorCode ErrorCode { get; }
    ...
    public ServiceException(
        WellKnownSIStorageServiceErrorCode errorCode,
    ...
    public ServiceException(WellKnownSIStorageServiceErrorCode errorCode, HttpStatusCode statusCode, Exception? innerException)
